...
int main()
{
	...
	*/
	...
	/* El último bloque condicinal  
	
	if (minuto_fin_ok) {
		datos_ok = true; 		
	}
		
	podría sustituirse por escribir en este punto (tras la lectura): 
			
	datos_ok = hora_inic_ok && hora_fin_ok && minuto_inic_ok && minuto_fin_ok; 
	          
	pero es más costoso (razone por qué).
	*/
	...
	if (datos_ok) {
		...
		if (tarifa_24h)
			...
			cout << "\tCorta     = " << setw(3)
				...
				<< setw(7) << setprecision(4) << cant_corta << endl;
			cout << "\tMedia     = " << setw(3)
			     << num_mins_media << " (x "
				 << setw(5) << setprecision(4) << CANT_MEDIA << ") = "
				 << setw(7) << setprecision(4) << cant_media << endl;
			cout << "\tLarga     = " << setw(3)
			     << num_mins_larga << " (x "
				 << setw(5) << setprecision(4) << CANT_LARGA << ") = "
				 << setw(7) << setprecision(4) << cant_larga << endl;
			cout << "\tMuy Larga = " << setw(3)
			     << num_mins_muy_larga << " (x "
				 << setw(5) << setprecision(4) << CANT_MUY_LARGA << ") = "
				 << setw(7) << setprecision(4) << cant_muy_larga << endl;
			cout << "                                     "
				 << "-------" << endl;
			cout << "                                     "
				 << setw(7) << setprecision(4) << suma_tramos << " E " << endl;
		}
		cout << endl;
