...
55. Reescribir el ejercicio 47 (fila más cercana de un conjunto de filas
...
Emplear la misma función main que se usó para la solución propuesta usando la
clase que empela una matriz clásica como dato privado. Si no ha tenido que
cambiar nada, la clase está bien construida.
...
public:
	...
	//El numero de elementos de la secuencia es el valor que se usa como
	//col_utilizadas.
	...
	*******************************************************************/
	...
	/**************************************************************************
	Metodo VectorSimilar: que busca en la matriz dato miembro del objeto la fila
	...
	***************************************************************************/
	...
	SecuenciaEnteros filas_a_comparar)
	{
		...
		resultado con los valores de la primera fila (en este caso la fila es
		una secuencia)*/
