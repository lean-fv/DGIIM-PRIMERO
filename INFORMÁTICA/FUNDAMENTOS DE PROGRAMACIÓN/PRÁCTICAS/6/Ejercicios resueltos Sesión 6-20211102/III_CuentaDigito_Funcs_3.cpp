...
/***************************************************************************/
// Función que calcula y devuelve el número de veces que una cifra 
// (dígito) aparece en total en todos los números de un intervalo.
//
// Recibe: 
//		cifra: el dígito a localizar
//		izda: extremo izquierdo del intervalo 
//		dcha: extremo derecho del intervalo 
// Devuelve: el número total de apariciones de "cifra" en todos 
//			 los números entre "izda" y "dcha"
//
// PRE: 0 <= "cifra" <= 9
// PRE: "izda" <= "dcha"

int NumVecesCifraEnIntervalo (int cifra, int izda, int dcha)
{
	
    int veces_total = 0; // Num. veces que "cifra" aparece en total

    for (int num=izda; num<=dcha; num++) {
...
int main()
{
	...
	int veces_total = NumVecesCifraEnIntervalo (cifra, min, max);
